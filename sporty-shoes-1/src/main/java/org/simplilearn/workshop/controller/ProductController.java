...
public class ProductController {
    ...
    ProductService service;
	 ...
	 public String showProduct(ModelMap model,@RequestParam String date,@RequestParam String category){

	        boolean isValidProduct = service.validateProduct(date,category);
